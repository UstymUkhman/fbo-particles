import { RGBAFormat, FloatType, NearestFilter } from '@three/constants.js';
...
export default class Fbo {
  constructor (width, height, renderer, simulationMaterial, renderMaterial) {
    ...
    const options = {
      ...
      format: RGBAFormat, // Could be also RGBAFormat
    ...
    // Create Particles and set a target texture:
  ...
  // 7. Update loop setup:
  update () {
    // Updates the simulation and clear the result in a target texture:
